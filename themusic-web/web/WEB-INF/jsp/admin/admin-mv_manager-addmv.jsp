...
<form id="formData" class="layui-form">
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="mvId" readonly="readonly" value="${mvId}" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
        ...
        <div id="mv_img" title="选择图片">
            <img id="pic" name="pic" src="/file/themusic/img/mv/添加mv.jpg" style="width:190px;height:155px;" />
            <input id="uploadImg" name="files" type="file" style="display: none;" />
            <input id="pictureSrc" name="mvPicture"  style="display:none" />
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="mvName" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="songId"  autocomplete="off" class="layui-input">
            </div>
        </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="mvClick"  autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline" style="width:310px;">
            ...
            <div class="layui-input-inline" style="width:80px;">
                <input type="text" id="mvSrc" name="mvSrc"  autocomplete="off" class="layui-input" readonly="readonly" style="width:80px;">
            </div>
        ...
        <div class="layui-inline">
            ...
            <!--这个仅仅用于间接读取音频文件的时长-->
            <div class="layui-input-inline">
                <input type="text" id="mvLength" name="mvLength"  autocomplete="off" class="layui-input" readonly="readonly">
            </div>
        </div>
    </div>
