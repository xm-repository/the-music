...
<form id="formData" class="layui-form">
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="songId" readonly="readonly" value="${songId}" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
        ...
        <div id="song_img" title="选择图片">
            <img id="pic" name="pic" src="/file/themusic/img/song/添加歌曲.jpg"  style="width:190px;height:155px;" />
            <input id="uploadImg" name="files" type="file" style="display: none;" />
            <input id="pictureSrc" name="pictureSrc" style="display:none"/>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="singerId"  autocomplete="off" class="layui-input">
            </div>
        </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="albumId"  autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">发表日期</label>
            <div class="layui-input-inline">
                <input type="text" name="publishDate"  id="date"   placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
            </div>
        </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="songLanguage" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">播放数</label>
            <div class="layui-input-inline">
                <input type="text" name="songClick" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline" style="width:310px;">
            ...
            <div class="layui-input-inline" style="width:80px;">
                <input type="text" id="songSrc" name="songSrc"   autocomplete="off" class="layui-input" readonly="readonly" style="width:80px;">
            </div>
